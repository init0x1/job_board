                            ...
                            <div class="card h-100 border-primary hover-shadow">
                                <div class="card-body text-center p-4">
                                    ...
                                    <form action="{{ route('select.role') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary w-100 py-3">Continue as Candidate</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-success hover-shadow">
                                <div class="card-body text-center p-4">
                                    ...
                                    <form action="{{ route('select.role') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success w-100 py-3">Continue as Employer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
